...
class SignupScreen extends Component {
  ...
  isPasswordEmpty(input) {
    if (input == null || input == "") {
      ...
      this.setState({
        errorPassword: this.errorMessage("This is a required field.")
      });
    } else {
  ...
  isPasswordMatch() {
    if (this.state.password != this.state.confirmPassword) {
      this.password.current.setNativeProps(ScreenStyleSheet.formInputError);
      this.setState({
        errorPassword: this.errorMessage("These passwords do not match.")
      });
    } else {
      this.password.current.setNativeProps(ScreenStyleSheet.formInputValid);
      this.confirmPassword.current.setNativeProps(
  ...
  isEmailEmpty(input) {
    if (input == null || input == "") {
      ...
      this.setState({
        errorEmail: this.errorMessage("This is a required field.")
      });
    } else {
  ...
  isEmailValid(input) {
    ...
    if (!isEmailValid) {
      this.email.current.setNativeProps(ScreenStyleSheet.formInputError);
      this.setState({
        errorEmail: this.errorMessage("This email address is not valid.")
      });
    } else {
      this.isEmailMatch();
    }
  ...
  isEmailValidAll(input, error) {
    ...
    if (!isEmailValid) {
      if (error === "errorEmail") {
        ...
        this.confirmEmail.current.setNativeProps(
          ScreenStyleSheet.formInputError
        );
        this.setState({
          errorConfirmEmail: this.errorMessage(
  ...
  isEmailMatch() {
    if (this.state.email != this.state.confirmEmail) {
      this.email.current.setNativeProps(ScreenStyleSheet.formInputError);
      this.setState({
        errorEmail: this.errorMessage("These email addresses do not match.")
      });
    } else {
    ...
    if (this.isValid(input)) {
      ...
      // Checks if password match
        ...
        if (this.passwordMatch()) {
          ...
          this.setState({ errorPassword: null });
          this.setState({
            errorConfirmPassword: this.errorMessage(
    ...
    return (
      <Container>
        ...
        <Content contentContainerStyle={ScreenStyleSheet.content}>
          ...
          <View style={ScreenStyleSheet.rowContainer}>
            <View ref={this.email} style={ScreenStyleSheet.formRowInfo}>
              <TextInput
                autoCapitalize="none"
                style={ScreenStyleSheet.formInput}
          ...
          <View style={ScreenStyleSheet.rowContainer}>
            <View ref={this.confirmEmail} style={ScreenStyleSheet.formRowInfo}>
              <TextInput
                autoCapitalize="none"
                style={ScreenStyleSheet.formInput}
          ...
          <View style={ScreenStyleSheet.rowContainer}>
            <View ref={this.password} style={ScreenStyleSheet.formRowInfo}>
              <TextInput
                style={ScreenStyleSheet.formInput}
                secureTextEntry={true}
                onChangeText={this.onChange.bind(this, "password")}
                onEndEditing={this.isPasswordEmpty.bind(
                  this,
                  this.state.password,
                  this.password,
                  "errorPassword"
          ...
          <View style={ScreenStyleSheet.rowContainer}>
            ...
            <View ref={this.dob} style={ScreenStyleSheet.formRowInfo}>
              <DatePicker
                style={{ width: "100%" }}
                date={this.state.dob}
                mode="date"
